    ...
    return (
        <div style={styles.page}>
            ...
            <div style={styles.card}>
                <h2 style={styles.title}>Signup for Mentor</h2>
                ...
                <p style={styles.footer}>
                    ...
                    <Link href="/login" style={{ color: "#244855", fontWeight: 700 }}>Log in</Link>
                </p>
            </div>
        </div>
    );
...
const styles: { [key: string]: React.CSSProperties } = {
    page: {
        ...
        background: `radial-gradient(circle at 20% 30%, #7091E633 0%, transparent 40%),
                     radial-gradient(circle at 80% 70%, #124E6633 0%, transparent 40%),
    ...
    card: {
        ...
        border: "2px solid #244855", boxShadow: "0 25px 50px rgba(0,0,0,0.4)", zIndex: 10,
    },
    title: { marginBottom: "20px", color: "#244855", textAlign: "center" as const, fontWeight: 800, fontSize: "22px" },
    ...
    button: {
        ...
        backgroundColor: "#244855", color: "#fff", fontWeight: 700, fontSize: "16px",
